...
drop table if exists audio_languages CASCADE;
drop table if exists subs_languages CASCADE;
...
insert into audio_languages (name) values ('magyar');
insert into audio_languages (name) values ('angol');
insert into audio_languages (name) values ('koreai');
insert into audio_languages (name) values ('kínai');
insert into audio_languages (name) values ('japán');

insert into sub_languages (name) values ('magyar');
insert into sub_languages (name) values ('magyar-kiegészítő');
insert into sub_languages (name) values ('angol');
insert into sub_languages (name) values ('angol-kiegészítő');
